/* 
 * Copyright 2014-2016 MICRORISC s.r.o.
 *
...
public class J_CDCImpl {
    ...
    private static native void init(ClassLoader classLoader); 
     ...
     */
    static {
        System.loadLibrary("cdc_javastub");
        init(J_CDCImpl.class.getClassLoader());
    }
